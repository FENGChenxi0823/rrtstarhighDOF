...
if __name__ == "__main__":
    ...
    print lowerlimit
    print upperlimit
    #[-0.5646018  -0.35360022 -2.12130808 -0.65000076 -2.0000077 ]
    #[ 2.13539289  1.29629967 -0.15000005  3.74999698 -0.10000004]

    with env:
    	print startconfig
        goalconfig = [0.449,-0.201,-0.151,0,-0.11]
        goalconfig = [0.649,0.801,-0.151,0,-0.11]
        ...
        '''
        rrt=RRTStar(env, robot, startconfig, goalconfig, lowerlimit, upperlimit)
        ...
        with open('../results/maxtimeHD/highs70i50.csv', mode='w') as rrtFile:
            ...
            for i in range(1,11,1):
                rrt=RRTStar(env, robot, startconfig, goalconfig, lowerlimit, upperlimit)
                path,allcosts,alltimes,samples=rrt.RRTSearchMaxTime()
                print path
                print allcosts
